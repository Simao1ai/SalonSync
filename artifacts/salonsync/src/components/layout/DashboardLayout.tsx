  ...
  return (
    <div className="flex h-screen bg-[#080C14] text-white overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top header */}
        <header className="h-[60px] border-b border-white/[0.06] flex items-center justify-between px-6 shrink-0 bg-[#080C14]/80 backdrop-blur-sm">
          {/* Breadcrumb */}
          <div className="flex items-center gap-1.5 text-sm">
            {meta.crumb && (
              <>
                <span className="text-white/30 font-medium">{meta.crumb}</span>
